...
create_label "scripts"       "1D76DB" "Cambios en los scripts de instalación"
create_label "config"        "D4C5F9" "Cambios en configuración del repo"
...
create_label "task"             "C5DEF5" "Tarea de trabajo"
